    ...
    -- Library element functions
        function library:window(properties)
            ...
            local items = cfg.items; do
                ...
                local time_left = tostring((LRM_SecondsLeft < math.huge and ""..tostring(math.floor(((LRM_SecondsLeft / 60) / 60) / 24)).." days" or LRM_SecondsLeft == math.huge and "Free"))
        ...
        function library:init_config(window) 
            ...
            section:keybind({name = "Menu Bind", key = Enum.KeyCode.RightShift, callback = function(bool) window.toggle_menu(bool) end, seperator = true, default = true})
        ...
        function library:window(properties)
            ...
            local items = cfg.items; do
                ...
                items[ "other_info" ] = library:create( "TextLabel" , {
                    ...
                    TextColor3 = themes.preset.accent;
                    BorderColor3 = rgb(0, 0, 0);
                    Text = '<font color="rgb(255, 255, 255)">'..time_left..', </font>' .. cfg.name:lower() .. cfg.suffix:lower();
                    Size = dim2(1, 0, 0, 0);
                    Position = dim2(0, -10, 0.5, -1);
                    AnchorPoint = vec2(0, 0.5);
                    BorderSizePixel = 0;
